...
export function HamburgerMenu({ children, className }: HamburgerMenuProps) {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-black backdrop-blur-md border-b border-orange-500/20">
      ...
      <aside
        className={cn(
          "lg:hidden fixed inset-y-0 right-0 z-50 w-80 transform transition-transform duration-300 ease-in-out bg-black backdrop-blur-md border-l border-orange-500/20 flex flex-col",
